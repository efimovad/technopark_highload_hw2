...
На основе исследований [4](https://www.percona.com/blog/2017/01/06/millions-queries-per-second-postgresql-and-mysql-peaceful-battle-at-modern-demanding-workloads/) один клиент может делать примерно 10000 qps, что достаточно для нагрузки микросервиса 1000 rps 
...
На основе исследований [5](http://smalldatum.blogspot.com/2014/04/concurrent-read-only-not-cached-mongodb.html) на 8 ядрах обеспечивается 15 000 qps, что достаточно для 6000 rps микросервиса. 
