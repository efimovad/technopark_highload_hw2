...
Отметим еще раз, что для хранения данных мы будем использовать postgres и mongodb. Т.к. нам необходим быстрый поиск по объявлениям будем использовать технологию MongoDB Atlas Full-Text Search, которая основана на Apache Lucene. 
